...
export const projects: Project[] = [
  {
    ...
    techStack: ["React Native", "TypeScript", "Redux Toolkit", "Axios", "Socket.io", "Turbo Monorepo", "Firebase", "LiveKit", "Expo"],
  ...
  },
  {
    ...
    title: "Public App",
    company: "Transnovasi (Korlantas Polri)",
    techStack: ["React Native", "JavaScript", "Turbo Monorepo", "Axios", "Firebase", "Redux"],
    links: {
  ...
  },
  {
    ...
    company: "PINA",
    techStack: ["React Native", "JavaScript", "OAuth", "Axios", "SSE", "Redux", "Firebase"],
    links: {
  ...
  },
  {
    ...
    techStack: ["React Native", "JavaScript", "Figma", "Redux"],
  ...
  },
  {
    ...
    title: "Koop",
    company: "PT. Teknologi Kupon Digital",
    techStack: ["Java (Android)", "React Native", "JavaScript", "PHP", "Sentry", "Redux"],
